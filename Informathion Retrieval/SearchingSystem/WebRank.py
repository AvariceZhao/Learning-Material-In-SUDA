...
def init():
    ...
    file = open("./InvertedIndex/InvertedIndex.txt", encoding='utf8')
...
def WebRankQuery(QuerySentence: str):
    ...
    def OutAns(ans: list, WordList: list, Q: str):  # 输出查询结果到文件
        ...
        for unit in ans:
            ...
            QueryAnswer.append([unit[0], Content[max(p - 60, 0):p + 60:1]])
    ...
    def Query(s: str):  # 查询函数
        ...
        return OutAns(ans, WordList, s)  # 输出查询结果

    # indexDict[word][WordTOIndex[word]][1]
    #   print(Query(QuerySentence))
